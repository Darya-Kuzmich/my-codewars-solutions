...
# in a given base. In this Kata, we will restrict ourselves to decimal (base 10).  # noqa
#
...
def narcissistic(value: int) -> bool:
    value_nums = [int(sym) for sym in str(value)]
    powered_nums = list(map(lambda num: num ** len(value_nums), value_nums))
    return sum(powered_nums) == value
